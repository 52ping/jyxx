...
<a href="${url2 }add"><span style="font-size: 25px;">添加新专业</span></a>
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    
    
    <tr>
    <td class="td_bg"  height="23">所属系</td>
      <td class="td_bg"  height="23">专业名称</td>
    ...
    <tr>
    <td class="td_bg"  height="23">${bean.xi.name }</td>
