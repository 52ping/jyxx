...
<td class="td_bg" >从事行业</td>
 <td class="td_bg"  height="23">职位类别</td>
    ...
    <tr>
     ...
     <td class="td_bg"  height="23">${bean.zhiweifaburen.qiyemingchen }</td>
      <td class="td_bg"  height="23">${bean.zhiweifaburen.congshihangye }</td>
      ...
      <td class="td_bg" >
       ...
       <a href="method!toutijianli?id=${bean.id }"><span style="font-size: 15px;">应聘就业岗位</span></a>
