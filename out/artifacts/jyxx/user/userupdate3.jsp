...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      ...
      <td class="td_bg" >${bean.username }</td>
   ...
   <tr>
    ...
    <tr>
     ...
     <tr>
      <td class="td_bg"  height="23">修改系</td>
      <td class="td_bg" >
     ...
     <tr>
      <td class="td_bg"  height="23">修改专业</td>
      <td class="td_bg" >
    ...
    <tr>
      ...
      <td class="td_bg" >
      <select name="nianji">
      <option value="2009级" <c:if test="${bean.nianji=='2009级' }">selected</c:if> >2009级</option>
       <option value="2010级" <c:if test="${bean.nianji=='2010级' }">selected</c:if> >2010级</option>
        <option value="2011级" <c:if test="${bean.nianji=='2011级' }">selected</c:if> >2011级</option>
         <option value="2012级" <c:if test="${bean.nianji=='2012级' }">selected</c:if> >2012级</option>
          <option value="2013级" <c:if test="${bean.nianji=='2013级' }">selected</c:if> >2013级</option>
      </select>
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="banji" value="${bean.banji }" /></td>
    ...
    <tr>
      ...
      <td class="td_bg" ><input type="text" name="lianxifangshi" id="lianxifangshiid"  value="${bean.lianxifangshi }"/></td>
     
    </tr>
    
    <tr>
      <td class="td_bg"  height="23">联系地址</td>
      <td class="td_bg" ><input type="text" name="lianxidizhi" value="${bean.lianxidizhi }" /></td>
