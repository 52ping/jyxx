...
<table class="table" cellspacing="1" cellpadding="2" width="99%" align="center" border="0">
  <tbody>
    ...
    <tr>
      <td class="td_bg"  height="23" width="10%" >标题</td>
      <td class="td_bg" width="90%" align="center">${bean.title }</td>
     
    </tr>
    
   <tr>
      <td class="td_bg"  height="23" width="10%">内容</td>
      <td class="td_bg" width="90%" >
      ${bean.content }
      </td>
